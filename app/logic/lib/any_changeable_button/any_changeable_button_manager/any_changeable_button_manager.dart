...
mixin AnyChangeableButtonManager<T>{
  ...
  bool get _isNotWorkingAlready =>
      !_blocTypes.values.any((bloc) => bloc.state is! InitialAnyChangeableButtonState);
  ...
  AnyChangeableButtonBloc getBlocForMethod(T type) =>
      _blocTypes.putIfAbsent(type, () => _addBloc(type));
